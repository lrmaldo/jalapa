...
function initMap(elem) {
    ...
    //var lat = parseFloat($e.attr('data-map-lat') || 18.0929877);
    //var long = parseFloat($e.attr('data-map-long') || -96.1296194);
	var lat = parseFloat($e.attr('data-map-lat') || 18.0905299);
    var long = parseFloat($e.attr('data-map-long') || -96.1268029);
	
    var zoom = parseInt($e.attr('data-map-zoom') || 19);
