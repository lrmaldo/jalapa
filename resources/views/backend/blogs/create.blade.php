            ...
            <div class="px-4 py-5 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                ...
                <form action="{{route('blog.store')}}" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="p-3">
                        ...
                        <x-jet-input id="titulo" name="titulo" type="text" class="mt-1 block w-full" value="{{old('titulo','')}}"
                            autocomplete="titulo" />
                    ...
                    <div class="p-3">
                        ...
                        <textarea cols="80" id="contenido" class="block w-full mt-1 rounded-md" name="contenido" rows="10">{{old('contenido','')}}</textarea>
